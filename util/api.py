...
class API(object):
    ...
    def login(self, email, password):
        ...
        info, result = self.__net.request(
            self.__class__.LOGIN_URL,
            "POST",
            param_dict
        )
    ...
    def fetch_pls(self, cmbt, uid):
        ...
        _, result = self.__net.request(
            self.__class__.FETCH_PLS_URL,
            "POST",
            param_dict,
            self.__header_dict
        )
    ...
    def fetch_track(self, mid):
        ...
        _, result = self.__net.request(
            self.__class__.FETCH_TRACK_URL,
            "POST",
            param_dict,
            self.__header_dict
        )
    ...
    def fetch_track_info(self, uid, tid):
        ...
        _, result = self.__net.request(
            self.__class__.FETCH_TRACK_INFO_URL,
            "POST",
            param_dict,
            self.__header_dict
        )
